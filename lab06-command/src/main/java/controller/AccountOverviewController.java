...
public class AccountOverviewController {
	...
	private void handleDeleteAction(ActionEvent event) {
		List<Transaction> transactionList = List.copyOf(transactionsTable.getSelectionModel().getSelectedItems());
		RemoveTransactionCommand removeTransactionCommand = new RemoveTransactionCommand(transactionList, data);
